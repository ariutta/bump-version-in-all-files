      ...
      return Rx.Observable.if(
        ...
        .concatMap(function(newVersion) {
          ...
          .concatMap(function(pair) {
            ...
            console.log('main: before findAndReplaceSource');
                    ...
                    .map(function(file) {
                      ...
                      var customUpdaters = {
                        'package.json': function(o) {
                          ...
                          console.log('main: packageJsonString331');
                          console.log(packageJsonString);
                          return o.last().map(function(x) {
                            console.log('main: x in map335');
                            console.log(x);
