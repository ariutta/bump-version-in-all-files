...
var semverBumperForFileText = {};

semverBumperForFileText.bump = function(opts) {
  opts = opts || {};
  ...
  return getPackageMetadata()
      ...
      return Rx.Observable.if(
        ...
        .concatMap(function(newVersion) {
          ...
          if (jsonFiles) {
            ...
            jsonFilesSource = getJsonFiles()
              ...
              .doOnNext(function(jsonFiles) {
                var current = npmPackage.semverBumper || {};
                current.jsonFiles = jsonFiles;
                npmPackage.semverBumper = current;
              });
          }

          var grepOptions = npmPackage.semverBumper.grepOptions;
          ...
          .concatMap(function(pair) {
            ...
            grepOptions = pair[1];
            npmPackage.semverBumper.grepOptions = grepOptions;
    ...
    .doOnError(function(err) {
      var newError = new VError(err, 'Error with semverBumperForFileText');
      console.error(newError.stack);
    });
};

semverBumperForFileText.set = function(opts) {
  // TODO
  // set JSON files
...
module.exports = semverBumperForFileText;
